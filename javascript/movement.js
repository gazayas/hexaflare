/*
  TODO: Most of this code was simply used to test out the gamepad, so
  before implementing anything with meaning, design this portion well
  (even if you have to make a class or write it in another file)
  before actually making the movement logic (implement a class like `StarClusterHandler`?)

  Remember to add it to the scripts in either index.html or application.js
*/
